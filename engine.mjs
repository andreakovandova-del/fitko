...
export const FOODS = {
  ...
  tunak_konzerva: { name: 'Tuňák ve vlastní šťávě (okapaný)', cat: 'maso', kcal: 110, p: 25, c: 0, f: 1, packG: 110, packLabel: '1 konzerva', match: ['tunak'] },
  ...
  bily_jogurt: { name: 'Bílý jogurt 3 %', cat: 'mlecne', kcal: 65, p: 4, c: 5, f: 3, packG: 150, match: ['bily jogurt', 'jogurt bily'] },
  ...
  smetanovy_syr: { name: 'Smetanový sýr (Lučina typ)', cat: 'mlecne', kcal: 250, p: 6, c: 3, f: 24, packG: 200, match: ['lucina', 'smetanovy syr', 'zervais'] },
  ...
  // ---------- ovoce ----------
  banan: { name: 'Banán', cat: 'ovoce', kcal: 89, p: 1.1, c: 23, f: 0.3, pieceG: 120, packG: 1000, match: ['banan'], exclude: ['chips', 'susen'] },
  jablko: { name: 'Jablko', cat: 'ovoce', kcal: 52, p: 0.3, c: 14, f: 0.2, pieceG: 180, packG: 1000, match: ['jablk'], exclude: ['dzus', 'stava', 'mostu'] },
  pomeranc: { name: 'Pomeranč', cat: 'ovoce', kcal: 47, p: 0.9, c: 12, f: 0.1, pieceG: 200, packG: 1000, match: ['pomeranc'], exclude: ['dzus', 'stava'] },
  mandarinka: { name: 'Mandarinka', cat: 'ovoce', kcal: 53, p: 0.8, c: 13, f: 0.3, pieceG: 70, packG: 1000, match: ['mandarink', 'klementin'] },
  boruvky: { name: 'Borůvky', cat: 'ovoce', kcal: 57, p: 0.7, c: 14, f: 0.3, packG: 125, match: ['boruvk'] },
  jahody: { name: 'Jahody', cat: 'ovoce', kcal: 32, p: 0.7, c: 8, f: 0.3, packG: 250, match: ['jahod'] },
  ...
  hruska: { name: 'Hruška', cat: 'ovoce', kcal: 57, p: 0.4, c: 15, f: 0.1, pieceG: 170, packG: 1000, match: ['hrusk'] },
  ...
  rajcata: { name: 'Rajčata', cat: 'zelenina', kcal: 18, p: 0.9, c: 3.9, f: 0.2, pieceG: 120, packG: 500, match: ['rajcat', 'rajce'], exclude: ['cherry', 'loupan', 'protlak', 'konzerv', 'pasta'] },
  ...
  paprika: { name: 'Paprika', cat: 'zelenina', kcal: 31, p: 1, c: 6, f: 0.3, pieceG: 150, packG: 450, packLabel: '3 ks', match: ['paprika', 'papriky'], exclude: ['mleta', 'korenici'] },
  mrkev: { name: 'Mrkev', cat: 'zelenina', kcal: 41, p: 0.9, c: 10, f: 0.2, pieceG: 80, packG: 1000, match: ['mrkev'] },
  ...
  cibule: { name: 'Cibule', cat: 'zelenina', kcal: 40, p: 1.1, c: 9, f: 0.1, pieceG: 100, packG: 1000, match: ['cibule'] },
  cesnek: { name: 'Česnek', cat: 'zelenina', kcal: 149, p: 6.4, c: 33, f: 0.5, pieceG: 5, packG: 100, match: ['cesnek'] },
  ...
  fazole_konzerva: { name: 'Fazole (konzerva, okapané)', cat: 'lusteniny', kcal: 100, p: 7, c: 17, f: 0.5, packG: 240, packLabel: '1 konzerva', match: ['fazole'] },
  ...
  mandle: { name: 'Mandle', cat: 'tuky', kcal: 580, p: 21, c: 22, f: 50, packG: 200, match: ['mandle'], exclude: ['mleko', 'napoj'] },
  ...
  // ---------- ostatní ----------
  protein_syrovatkovy: { name: 'Syrovátkový protein (prášek)', cat: 'ostatni', kcal: 380, p: 78, c: 6, f: 5, pieceG: 30, packG: 1000, match: ['protein', 'whey'], exclude: ['tycink', 'napoj', 'pudink'] },
...
export function shoppingList(plan, meals, customFoods = [], discounted = {}) {
  ...
  for (const [foodId, g] of Object.entries(grams)) {
    ...
    const pieces = food.pieceG ? Math.ceil(g / food.pieceG) : null;
